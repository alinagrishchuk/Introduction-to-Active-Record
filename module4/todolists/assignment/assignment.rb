...
class Assignment
  ...
  def find_alllists(offset, limit)
    ...
    TodoList.order(list_due_date: :desc).limit(limit).offset(offset)
  end
  ...
  def update_password(id, password_digest)
    ...
    get_user_byid(id).update_attribute(:password_digest, password_digest)
  end
  ...
  def update_listname(id, name)
    ...
    # (no return is required)
    get_todolist_byid(id).update_attribute(:list_name, name)
  end 
