class TodoItemsController < ApplicationController
  ...
  def index
    ...
    @number_of_completed_todos = count_completed_todo_items
  end
  ...
  private
    ...
    def todo_item_params
      params.require(:todo_item).permit(:due_date, :title, :description, :complated)
    end

    def count_completed_todo_items
